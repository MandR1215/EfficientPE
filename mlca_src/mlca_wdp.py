...
class MLCA_WDP:
    ...
    def __init__(self, bids, timelimit:int=None):
        ...
        if timelimit is not None:
            self.Mip.set_time_limit(time_limit=timelimit)
    ...
    def solve_mip(self, verbose=0):
        ...
        logging.info('Optimal Allocation with Elicited Bids:')
...
logging.info('Class MLCA_WDP imported')
